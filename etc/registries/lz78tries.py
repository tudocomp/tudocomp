...
hash_roll = [
        ...
        AlgorithmConfig(name="KarpRabinHash64", header="util/hash/rabinkarphash.h"),
        AlgorithmConfig(name="KarpRabinHash128", header="util/hash/rabinkarphash.h"),
...
tdc.compressors = [
    ...
    AlgorithmConfig(name="LZ78PackedCompressor", header="compressors/LZ78PackedCompressor.hpp", sub=[universal_coders, lz78_trie]),
