...
/*
 This expects a set ofmethodsin Self, either

    // cast self to a 32bit value
    inline uint32_t cast_for_self_op() const {
        ...
    }

    // cast self to a 64bit value
    inline uint64_t cast_for_64_op() const {
        ...
    }

    // cast self to a 32bit value
    inline uint32_t cast_for_32_op() const {
        ...
    }

if Self has a bitness <= 32, or

    // cast self to a 64bit value
    inline uint64_t cast_for_self_op() const {
        ...
    }
    ...
    // cast self to a 64bit value
    inline uint64_t cast_for_32_op() const {
        ...
    }

if Self has a bitness <= 64

Additional, it needs to provide

    /// Set self to the value v
    inline void assign(uint32_t v) {
        ...
    }

    /// Set self to the value v
    inline void assign(uint64_t v) {
        ...
    }
