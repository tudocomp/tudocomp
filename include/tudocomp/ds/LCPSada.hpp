...
sdsl::bit_vector construct_plcp_bitvector(Config&, const sa_t& sa, const text_t& text) {
...
template<class sa_t, class text_t, class select_t = sdsl::select_support_mcl<1,1>>
LCPSada<sa_t,select_t> construct_lcp_sada(Config& cfg, const sa_t& sa, const text_t& text) {
