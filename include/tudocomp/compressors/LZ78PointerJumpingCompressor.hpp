...
namespace lz_pointer_jumping {
    struct LZ78PointerJumping {
        ...
        using lz_state_t = lz_common::Lz78AlgoState<encoder_t, dict_t, stats_t>;
...
using LZ78PointerJumpingCompressor = lz_pointer_jumping::BaseLZPointerJumpingCompressor<
    lz_pointer_jumping::LZ78PointerJumping, coder_t, dict_t>;
