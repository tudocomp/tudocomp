...
public:
    ...
    inline RegistryOf(const TypeDesc& root_type) : m_root_type(root_type) {
    }
    ...
    inline const TypeDesc& root_type() const {
        return m_root_type;
    }
...
template<typename T>
using RegistryOf = meta::RegistryOf<T>;
