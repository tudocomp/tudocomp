...
TEST(CodingPrototype, lzss_esacomp_naive_debug) {
    performTest<lzss::LZSSESACompressor<lzss::ESACompNaive, lzss::DebugLZSSCoder>>();
}

TEST(CodingPrototype, lzss_esacomp_naive_Aonline_Fonline) {
    performTest<lzss::LZSSESACompressor<lzss::ESACompNaive, lzss::OnlineLZSSCoder<OnlineAlphabetCoder>>>();
}

TEST(CodingPrototype, lzss_esacomp_naive_Aoffline_Fonline) {
    performTest<lzss::LZSSESACompressor<lzss::ESACompNaive, lzss::OnlineLZSSCoder<OfflineAlphabetCoder>>>();
}

TEST(CodingPrototype, lzss_esacomp_naive_Aonline_Foffline) {
    performTest<lzss::LZSSESACompressor<lzss::ESACompNaive, lzss::OfflineLZSSCoder<OnlineAlphabetCoder>>>();
}

TEST(CodingPrototype, lzss_esacomp_naive_Aoffline_Foffline) {
    performTest<lzss::LZSSESACompressor<lzss::ESACompNaive, lzss::OfflineLZSSCoder<OfflineAlphabetCoder>>>();
}
