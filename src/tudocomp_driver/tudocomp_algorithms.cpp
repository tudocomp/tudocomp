...
void register_algorithms(Registry& r) {
    ...
    r.register_compressor<ESACompressor<Code2Coder, esacomp::MaxHeapStrategy,  esacomp::MyMapBuffer>>();
    r.register_compressor<ESACompressor<Code2Coder, esacomp::MaxLCPStrategy,   esacomp::MyMapBuffer>>();
    r.register_compressor<ESACompressor<Code2Coder, esacomp::LazyListStrategy, esacomp::MyMapBuffer>>();
    ...
    r.register_compressor<ESACompressor<ASCIICoder, esacomp::MaxHeapStrategy,  esacomp::MyMapBuffer>>();
    r.register_compressor<ESACompressor<ASCIICoder, esacomp::MaxLCPStrategy,   esacomp::MyMapBuffer>>();
    r.register_compressor<ESACompressor<ASCIICoder, esacomp::LazyListStrategy, esacomp::MyMapBuffer>>();
